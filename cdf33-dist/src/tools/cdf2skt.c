  ...
  default:
    ...
    **************************************************************************/
	...
	if (qop->qualEntered[VALUESqual]) {
	  ...
	  if (strcmpIgCase(qop->qualOpt[VALUESqual],"none") != 0)
	    varValues = NOvalues;
	  else if (strcmpIgCase(qop->qualOpt[VALUESqual],"nrv") != 0)
	    varValues = NRVvalues;
	  else if (strcmpIgCase(qop->qualOpt[VALUESqual],"rv") != 0)
	    varValues = RVvalues;
	  else if (strcmpIgCase(qop->qualOpt[VALUESqual],"all") != 0)
	    varValues = ALLvalues;
	  else {
