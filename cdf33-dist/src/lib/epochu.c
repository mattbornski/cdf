...
{
  char tmp[EPOCH16_1_STRING_LEN+1];
...
void encodeEPOCH16x3 (epoch, encoded)
double epoch[2];
char *encoded;
{
  char tmp[17+1];
...
long year, month, day, hour, minute, second, msec;
{
  ...
  ****************************************************************************/
  if (year == 9999 && month == 12 && day == 31 && hour == 23 &&
      minute == 59 && second == 59 && msec == 999) return -1.0*pow(10.0, 31.0);
...
double epoch[2];
{
  ...
  ****************************************************************************/
  if (year == 9999 && month == 12 && day == 31 && hour == 23 &&
      minute == 59 && second == 59 && msec == 999 && usec == 999 &&
      nsec == 999 && psec == 999) {
    epoch[0] = -1.0E31;
    epoch[1] = -1.0E31;
    return 0.0;
